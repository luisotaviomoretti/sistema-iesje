-- =====================================================
-- MIGRATION: 040_enroll_finalize_inadimplencia_guard.sql
-- DESCRIÇÃO: Reforço server-side na RPC enroll_finalize
--            - Pré-checagem via public.check_inadimplencia()
--            - Respeita flag rematricula.inadimplencia.enabled (RPC retorna falso se off)
--            - Não altera contratos (assinatura e retorno idênticos)
-- DATA: 2025-09-15
-- AUTOR: Cascade
-- =====================================================
...
IS 'Finaliza matrícula com checagem de inadimplência (quando flag estiver ON). Insert atômico em enrollments + enrollment_discounts e idempotência via client_tx_id; SECURITY INVOKER.';
