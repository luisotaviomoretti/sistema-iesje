-- =====================================================
-- TEST: rematricula_payment_notes_fase1_verify.sql
-- Objetivo: Verificar aplicação da migração 042_add_payment_notes_to_enrollments
...
-- 2) Verificar existência da constraint de comprimento
SELECT EXISTS (
  SELECT 1
